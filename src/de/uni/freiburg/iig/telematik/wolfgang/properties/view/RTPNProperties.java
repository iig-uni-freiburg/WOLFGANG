...
public class RTPNProperties extends PNProperties {

	public RTPNProperties(GraphicalTimedNet ptNet) {
		super(ptNet);
	}
	 ...
	 */
	@Override
	protected GraphicalTimedNet getNetContainer() {
	...
	/**
	 * Overrides super{@link #getArcProperties()} and adds property
	 * {@link PNProperty#ARC_WEIGHT}.
	 */
	@Override
	...
	/**
	 * Overrides super{@link #getArcProperty(String, PNProperty)} and
	 * additionally considers property {@link PNProperty#ARC_WEIGHT}.<br>
	...
	/**
	 * Overrides super
	 * {@link #setArcProperty(Object, String, PNProperty, String)} and
	 * additionally considers property {@link PNProperty#ARC_WEIGHT}.<br>
	 ...
	 * 
	 * @param arcName
	 *            The name of the arc whose weight is requested.
	 * @return The weight of the arc with the given name. @ If the given arc
	 *         name is <code>null</code> or the net does not contain an arc with
	 *         the given name.
	 */
	 ...
	 * 
	 * @param sender
	 *            The object which is requesting an arc weight change.
	 * @param arcName
	 *            The name of the arc whose weight is changed.
	 * @param wight
	 *            The new weight for the arc. @ If the given arc name is
