...
public class ReleaseUtils {
        ...
        private void getLatestReleaseObject() throws MalformedURLException, ParseException {
                try {
                        ...
                        /*
                         * This syso is on purpose, so people without internet connection won't get an exception every time they open Wolfgang.
                         */
                        System.out.println("Offline mode? Can't check for new version: " + ex.getMessage());
                }
        }
}
